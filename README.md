...
### App Usage Notes:
 ...
 - The Checklist, Settings and File Creator and Editor apps require an IDE to save changes, so don't use them unless you're fine with running the AarOS on an IDE.
